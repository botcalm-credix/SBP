    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
            ...
            <div className="bg-dark-900 border border-dark-700 rounded-2xl w-full max-w-5xl relative shadow-2xl overflow-hidden flex flex-col md:flex-row animate-in zoom-in-95 duration-200 max-h-[90dvh] md:max-h-[90vh]">
                ...
                {/* Right Side - Form */}
                <div className="w-full md:w-7/12 bg-dark-900 flex flex-col relative h-[90vh] lg:h-[80vh] p-6 min-h-0">
                    {/* Close button */}
                    <button
                        onClick={onClose}
                    ...
                    {/* Scrollable Content */}
                    <div className="flex-1 overflow-y-auto pr-1 space-y-6 scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-gray-900">
                        {/* Bonus Selection */}
                        <div className="mb-6">
                            <label className="block text-xs font-bold text-gray-500 mb-3 uppercase tracking-wider">
                                Choose a welcome bonus
                            </label>
